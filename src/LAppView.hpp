...
public:
    ...
    */
    ...
    LAppSpriteShader* GetSpriteShader() { return _spriteShader; }
    ...
    */
    ...
    void SetRenderTargetClearColor(float r, float g, float b);
     ...
     // --- 新增这个函数 ---
    Csm::CubismViewMatrix* GetViewMatrix() { return _viewMatrix; }

    /**
     * @brief   根据当前模型的变换，重新计算并设置窗口的大小和位置
     * @param[in]   shouldReposition    是否需要将窗口定位到屏幕右下角
     */
    void ResizeWindowToFitModel(bool shouldReposition); // <--- 添加这行

    void ProjectToScreen(float modelX, float modelY, float& screenX, float& screenY);
