...
public:
    ...
    */
    ...
    bool IsModelLoadedAndNeedResize() const { return _isModelLoadedAndNeedResize; }

    void OnResizeWindowExecuted() { _isModelLoadedAndNeedResize = false; }
...
private:
    ...
    */
    ...
    bool _isModelLoadedAndNeedResize;

    Csm::csmUint32 _tapCount;    
    Csm::csmFloat32 _lastTapTime; 
};
